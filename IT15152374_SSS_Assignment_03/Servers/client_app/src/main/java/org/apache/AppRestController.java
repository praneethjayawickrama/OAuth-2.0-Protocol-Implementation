...
public class AppRestController {
    ...
    @RequestMapping(value = "/login-wildparadise", method=RequestMethod.GET)
    public RedirectView processForm1() {
        RedirectView redirectView = new RedirectView();
        redirectView.setUrl("http://localhost:7051/auth/oauth/authorize?response_type=code&client_id=9876543210&redirect_url=http://localhost:7053/oauth/access?key=value&scope=user_read%20user_write");
        return redirectView;
    }
    ...
    {
        String auth_url = "http://localhost:7051/auth/oauth/token";
        ...
        try
        {
            ...
            con.setRequestProperty("Authorization", "Basic OTg3NjU0MzIxMDphc2RmZzM0ZGY=");
    ...
    public String getResource(String accessToken)
    {
        try
        {
            String ResourceUrl = "http://localhost:7050/users";
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) //success
            {
                ...
                String output = "<html><body><h2>Customer List</h2><table>";
                output += "<tr><th>ID</th><th>Name</th><th>Profession</th></tr>";
